...
```{r 7}
ggplot(gm1952,aes(x=lifeExp,y=lgdpPercap,color=continent)) + geom_point() + geom_smooth(method = "lm",se = FALSE)
gm1952 %>%
...
```{r 8}
ggplot(gm2007,aes(x=lifeExp,y=lgdpPercap,color=continent)) + geom_point() + geom_smooth(method = "lm",se = FALSE)
gm2007 %>%
